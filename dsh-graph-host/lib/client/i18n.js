    ...
    const zh = {
      ...
      'live.queue': '排队',
      'live.steer': '插队',
      'live.queueDepth': '队列 {n} 条待处理',
      'live.queuedDepth': '✅ 已排队（当前队列 {n} 条）',
      'live.activationLimit': '⚠️ 子代理激活已达上限（DSH 0.1.6 起默认 8 个活跃子代理）：请等待现有子代理结算，或先解绑不再需要的子代理后重试',
      'live.deliveryUnavailable': '⚠️ 子代理消息暂时无法送达（子代理未运行、父会话离线或已达激活上限）：请等待其结算，或重新派发该目标',
    ...
    const en = {
      ...
      'live.queue': 'Queue',
      'live.steer': 'Steer',
      'live.queueDepth': 'Queue: {n} pending',
      'live.queuedDepth': '✅ Queued ({n} in queue)',
      'live.activationLimit': '⚠️ Subagent activation limit reached (DSH 0.1.6 defaults to 8 active subagents): wait for an existing subagent to settle, or unbind one you no longer need and retry',
      'live.deliveryUnavailable': '⚠️ Subagent message temporarily undeliverable (subagent not running, parent session offline, or activation limit reached): wait for it to settle, or redeploy the goal',
      ...
      'live.modelPending': 'Model info pending',
